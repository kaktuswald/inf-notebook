    ...
    def get_recognitionresult(self, event: Event):
        ...
        if images[key]['details'] is not None:
            ...
            details = {
                ...
                'options': result.options.to_dict() if result.options else None,
                'cleartype': result.cleartype.to_dict() if result.cleartype else None,
                'djlevel': result.djlevel.to_dict() if result.djlevel else None,
                'score': result.score.to_dict() if result.score else None,
                'misscount': result.misscount.to_dict() if result.misscount else None,
