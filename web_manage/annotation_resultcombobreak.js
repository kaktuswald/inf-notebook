...
async function onclick_labeloverwrite(e) {
  ...
  values = {
    'combobreak': $('input#text_combobreak').val(),
  }
...
async function onclick_citationrecog(e) {
  $('input#text_combobreak').val(recognitionresult.combobreak);
}
