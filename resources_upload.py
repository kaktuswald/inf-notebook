...
if __name__ == '__main__':
    ...
    if '-all' in argv or '-resultothers' in argv:
        filename_resultothers = f'{define.resultothers_resourcename}.res'
        filepath_resultothers = join(resources_dirname, filename_resultothers)
        
        if upload(filename_resultothers, filepath_resultothers): 
            print(f'Upload complete {filename_resultothers}')
